...
const translations = {
    en: {
        ...
        edu1Detail1: "Overall Score: 2.2",
        edu1Detail2: "IT Courses Score: 1.3 (Scientific Programming with Python, Machine Learning for Quantum Scientists, Computational Physics)",
        edu1Detail3: "Physics Courses Score: 2.5 (Advanced Quantum Theory, Condensed Matter Physics, Quantum Optics, etc.)",
        edu2Title: "B.Sc. Applied Math & Physics",
        edu2Org: "Saint-Petersburg State University, Russia",
        edu2Date: "Sep 2019 - Jul 2023",
        edu2Detail1: "Graduated with distinctions (Score: 4.9/5.0, Top 1%)",
    ...
    de: {
        ...
        edu1Detail3: "Physikkurse Notendurchschnitt: 2,5 (Fortgeschrittene Quantentheorie, Festkörperphysik, Quantenoptik, etc.)",
